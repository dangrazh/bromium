...
fn to_rgba_image(
    ...
    unsafe {
        ...
        if is_failed {
            return Err(ScreenCaptureError::new("Get RGBA data failed"));
        }
    };
...
#[allow(unused)]
pub fn capture_monitor(x: i32, y: i32, width: i32, height: i32) -> ScreenCaptureResult<RgbaImage> {
    unsafe {
...
#[allow(unused)]
pub fn capture_window(hwnd: HWND, scale_factor: f32) -> ScreenCaptureResult<RgbaImage> {
