...
fn get_window_title(hwnd: HWND) -> ScreenCaptureResult<String> {
    unsafe {
...
fn get_module_basename(handle: HANDLE) -> ScreenCaptureResult<String> {
    unsafe {
...
fn get_app_name(pid: u32) -> ScreenCaptureResult<String> {
    unsafe {
...
impl ImplWindow {
    ...
    pub fn current_monitor(&self) -> ScreenCaptureResult<ImplMonitor> {
