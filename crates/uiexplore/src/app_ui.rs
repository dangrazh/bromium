...
impl UIExplorer {
    ...
    pub fn new(caption: String) -> Self {
        ...
        thread::spawn(|| {
            get_all_elements_xml(tx, None, None, Some(app_name));
        });
            ...
            ui.horizontal(|ui| {
                ...
                match self.app_mode {
                    AppMode::Normal(_) => {
                        ...
                        ui.label(" | ");
                        ui.add_space(2.0);
                        ui.label(format!("Screeninfo: {}x{} @ {:.1}x", self.app_context.screen_width, self.app_context.screen_height, self.app_context.screen_scale));
                        ui.add_space(2.0);
                    },
                    _ => {
